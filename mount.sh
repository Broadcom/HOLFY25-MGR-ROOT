#!/bin/bash
# 2025-02-21 - originl version
# 2025-12-03 - Burke Azbill - update to use password from creds.txt, fix variable names
#==============================================================================
...
MAINCON="mainconsole"
LMC=false
# the password MUST be available in the pod in order to complete the mount
...
if nc -z $MAINCON 2049; then
   log_message "LMC detected. Performing NFS mount..."
